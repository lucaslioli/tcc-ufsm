...
\label{sec:exp-engaj-balanc}
    ...
    \par O foco da análise neste gráfico, é a observação dos pontos em que a taxa de engajamento maximiza no número de instâncias balanceadas, isto é, o maior número possível de dados distribuídas entre as classes. No gráfico, isso é expressado pelo eixo \textit{y}, de forma que quanto mais próximo de um, maior é o aproveitamento dos dados de cada conta.
